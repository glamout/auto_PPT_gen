...
export const generateFinalSlideImage = async (
  ...
  const textPrompt = `
    ...
    4. **Image Integration**: 
       ...
       IMPORTANT: If provided, the user images MUST be visible in the final design.  Keep the originally user images unchanged; do not modify the content or colors.
